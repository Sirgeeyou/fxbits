...
export function ThreeDCardDemo({ listings }: ThreeDCardDemoProps) {
  const image =
    "https://gmygxkvjdilaoerggioq.supabase.co/storage/v1/object/public/listing-images/download%20(3).jpeg";
  return (
